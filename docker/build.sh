...
#docker build -f docker/Dockerfile -t raveberry/raveberry docker/
...
docker buildx build --platform linux/amd64,linux/arm/v7 --output type=registry -f docker/Dockerfile -t raveberry/raveberry docker/
echo "Publish using:"
